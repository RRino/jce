...
(function (tinymce) {
    ...
    tinymce.PluginManager.add('spellchecker', function (ed, url) {
        var self = this;
        var native_spellchecker = ed.getParam("spellchecker_engine", "browser") == 'browser';

        if (native_spellchecker) {
        ...
        ed.onInit.add(function () {
            if (native_spellchecker && ed.getParam('spellchecker_browser_state', 0)) {
                var body = ed.getBody();
                body.spellcheck = self.active = !self.active;
            }
        });
