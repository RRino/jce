...
(function (tinymce) {
    ...
    tinymce.PluginManager.add('upload', function (ed, url) {
        var self = this; self.plugins = [], self.files = [];
         ...
         */
        function bindUploadMarkerEvents (ed, marker) {
            var dom = tinymce.DOM;
                ...
                /*ed.dom.bind(select, 'click', function (e) {
                    ...
                    ed.execCommand('mceFileBrowser', false, {
                        callback: function (item, files) {
                            ...
                            if (plugin) {
                                selectAndInsert({ marker: marker, name: obj.title, uploader: plugin }, obj);
                            }
                        }
                    });
                });*/
        ...
        ed.onPreInit.add(function () {
            // get list of supported self.plugins
            ...
            ed.parser.addNodeFilter('img,media', function (nodes) {
                ...
                while (i--) {
                    ...
                    if (isMediaPlaceholder(node)) {
                        ...
                        // no self.plugins to upload, remove node
