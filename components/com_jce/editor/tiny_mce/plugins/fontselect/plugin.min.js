...
(function (tinymce) {
    ...
    var defaultFonts = "Andale Mono=andale mono,times;Arial=arial,helvetica,sans-serif;Arial Black=arial black,avant garde;Book Antiqua=book antiqua,palatino;Comic Sans MS=comic sans ms,sans-serif;Courier New=courier new,courier;Georgia=georgia,palatino;Helvetica=helvetica;Impact=impact,chicago;Symbol=symbol;Tahoma=tahoma,arial,helvetica,sans-serif;Terminal=terminal,monaco;Times New Roman=times new roman,times;Trebuchet MS=trebuchet ms,geneva;Verdana=verdana,geneva;Webdings=webdings;Wingdings=wingdings,zapf dingbats";
    ...
    tinymce.PluginManager.add('fontselect', function (ed, url) {
        ...
        function createFontSelect() {
            ...
            each(ed.getParam('fontselect_fonts', defaultFonts, 'hash'), function (v, k) {
                if (/\d/.test(v)) {
                    v = "'" + v + "'";
                }
