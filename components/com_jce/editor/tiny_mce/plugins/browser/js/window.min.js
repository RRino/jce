...
var wfe = {
    ...
    documentBaseURI: {
        toAbsolute: function(url) {
            ...
            var root = wfe.settings.document_base_url;
        ...
        toRelative: function(url) {
            if (/:\/\//.test(url)) {
                var base = wfe.settings.document_base_url;
    ...
    windowManager: {
        params: {
            ...
            callback: function (selected, data) {
                ...
                var elm = win.document.getElementById(wfe.settings.element);
        ...
        open: function (args, params) {
            ...
            args.url += '&' + wfe.settings.token + '=1&standalone=1';
            ...
            // store params
            wfe.windowManager.params = params;
        },
