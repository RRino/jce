...
(function (tinymce) {
    ...
    tinymce.create('tinymce.themes.AdvancedTheme', {
        ...
        init: function (ed, url) {
            ...
            // Load CSS - now loaded externally
            if (!ed.settings.compress.css && ed.settings.load_theme_css) {
                // load default skin
        ...
        renderUI: function (o) {
            ...
            var skin = 'mce' + ucfirst(ed.settings.skin) + 'Skin';

            if (s.skin_variant) {
                // eg: mceDefaultSkinTouch
                skin += ' ' + skin + ucfirst(s.skin_variant);
            }
        ...
        resizeTo: function (w, h, store) {
            ...
            if (store && s.use_state_cookies !== false) {
                tinymce.util.Storage.setHash("wf_editor_size_" + ed.id, {
                    cw: w,
                    ch: h
                });
            }
        ...
        _addStatusBar: function (tb, o) {
            ...
            if (s.theme_resizing) {
                ...
                if (s.use_state_cookies !== false) {
                    ed.onPostRender.add(function () {
                        var o = tinymce.util.Storage.getHash("wf_editor_size_" + ed.id);
